...
if "PREFERENCE_RAW_WORD_WRAP" in source:
    print("Raw word-wrap controls are already present.")
    raise SystemExit(0)
...
for old, new in replacements:
    if old not in source:
        raise SystemExit("Expected MainActivity source fragment was not found:\n" + old)
